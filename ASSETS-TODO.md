# Assets manquants — suivi

Suivi des images à fournir / corriger sur le site. Cocher au fur et à mesure.
Convention : noms en minuscules-tirets, rangés par usage dans `assets/`.
...
## 🟧 Logos clients — `assets/clients/`

Grille « Une vingtaine de structures accompagnées » (À propos).
**✅ Plus aucun placeholder — toutes les cellules ont un logo.**

- [x] `assets/clients/ping-full-logo.png`
- [x] `assets/clients/leezay-full-logo.png`
- [x] `assets/clients/libelaw-full-logo.png`
...
bolle, aviva-cuisines, paris-je-taime, strate-ecole-design, mobbles.
